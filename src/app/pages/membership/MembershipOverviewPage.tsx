      ...
      <main className="py-16 sm:py-20">
        <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-slate-200 bg-white p-8 sm:p-10 shadow-sm">
            ...
            <h1 className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">Membership Overview</h1>
            <p className="mt-4 max-w-3xl text-slate-600">A high-level summary of what public membership includes and who it is designed for.</p>
            ...
            <Link to="/membership/inclusions" className="mt-8 inline-flex items-center rounded-xl bg-blue-700 px-5 py-2.5 text-sm font-bold text-white hover:bg-blue-800 transition-colors">
              View Inclusions
            </Link>
          </div>
        </div>
