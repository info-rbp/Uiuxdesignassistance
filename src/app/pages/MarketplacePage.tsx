...
const products: Product[] = [
  ...
  { id: "doc-compliance", name: "Compliance Document Bundle", category: "Documents & Compliance", price: "$349", forWho: "All businesses", desc: "The essential compliance documents every business needs — privacy, policies, and legal templates.", includes: ["Privacy policy", "Compliance pack", "Terms & conditions", "Cookie policy", "Data retention schedule"], delivery: "Digital documents", timeline: "3–5 days" },
