...
add("");
add("1. Replace placeholder summaries in static data files with launch-safe copy.");
add("2. Expand Membership content before opening sign-up pathways.");
add("3. Review Legal pages with final legal/commercial wording.");
add("4. Add richer Marketplace listing data before backend work.");
add("5. Add real Help Center, Offers, and Resources content before admin editing.");
add("");
add("## Audit result");
add("");
...
const outputPath = path.join(root, "docs/public-content-readiness-audit.md");
